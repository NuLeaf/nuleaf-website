...
<div>
    ...
    <p>We are a Foothill College project that is in connection with the Advanced Studies Laboratories (ASL), which is in partnership with NASA Ames Research Center and UC Santa Cruz.
    </p>
    ...
    <p class="section-title"><span class="glyphicon glyphicon-triangle-right"></span>Why is this important?</p>
    <p>We want to help find a new clean and low-cost way to harvest energy.</p>
    ...
    <p>Below are emails you can contact us through. Please choose the appropriate address to send your requests and questions to. Your email will be routed to the correct person and we will get back to you as soon as possible.
        <ul>
            ...
            <li type="square"><b>Readware Teams:</b> <a href="readware@nuleaftech.com">readware@nuleaftech.com</a></li>
            <li type="square"><b>Hardware Teams:</b> <a href="hardware@nuleaftech.com">hardware@nuleaftech.com</a></li>
            <li type="square"><b>Liveware Teams:</b> <a href="liveware@nuleaftech.com">liveware@nuleaftech.com</a></li>
            <li type="square"><b>Software Teams:</b> <a href="software@nuleaftech.com">software@nuleaftech.com</a></li>
        </ul>
    </p>
...
<h3><b>How can I join NuLEAF Technologies?</b></h3><hr>
    ...
    <p>Application details will be released near the beginning of each season. Interviews will be conducted several weeks after. If you would like to be notified for when applications open, please send an email to <a     
    href="mailto:contact@nuleaftech.com">contact@nuleaftech.com</a> with the subject line "NuLEAF Application Notification".</p>

    <p class="section-title"><span class="glyphicon glyphicon-triangle-right"></span>I am not a US citizen. Can I still apply?</p>
    <p>Yes! Currently, many of our participants are from other countries. We hope to have a diverse group of students from different backgrounds. However, please be aware that you may or may not be placed in your desired group. Due to government regulations, certain groups that need access to specific resources will require that all its team members be US citizens.</p>

    <p class="section-title"><span class="glyphicon glyphicon-triangle-right"></span>What types of tasks will volunteers work on?</p>
    <p>Please refer to our <a href="teams.php">Teams page</a>. You will be assigned to be work in one of the teams.</p>

    <p class="section-title"><span class="glyphicon glyphicon-triangle-right"></span>How long is the volunteering duration period?</p>
    <p>The minimum volunteering period is one season (~3 months). However, you are welcome to volunteer as long as you like. Be mindful that there will be reevaluation periods at the beginning of each season for returning volunteers.</p>
    ...
    <p>No. You can simply send us an email letting us know you would like to continue to volunteer.</p>
    ...
    <p>No. Although, we highly recommend you be residing in the Bay Area, as this will make it much easier for you to commute to and from Team Meetings and STEMinars.</p>

    <p class="section-title"><span class="glyphicon glyphicon-triangle-right"></span>Where are the meetings held?</p>
    <p>Team Meeting locations are to be decided by Team Leaders, whereas, STEMinar will usually be held at Foothill College. There will usually be one Team Meeting and one STEMinar every week.</p>

    <p class="section-title"><span class="glyphicon glyphicon-triangle-right"></span>What is the expected time commitment?</p>
    <p>You are expected to attend every Team Meeting and STEMinar. You can expect to dedicate 5-10 hours a week. We will be taking surveys at the beginning of each season and try to schedule the meetings around the participants' summer schedule.</p>

</div>

<p class="center bold">Don't see your question here? Please email to: <a href="mailto:contact@nuleaftech.com">contact@nuleaftech.com</a> and we will try to get back to you as quickly as possible.</p>
