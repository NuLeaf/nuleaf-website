...
<div>
    ...
    <p>We are a Foothill College project that is in connection with ASL, which is in partnership with NASA Ames Research Center.
    </p>
...
<h3><b>How can I join NuLEAF Technologies?</b></h3><hr>
    ...
    href="mailto:nuleaftechnologies@gmail.com">nuleaftechnologies@gmail.com</a> with the subject line "NuLEAF Application Notification".</p>
    ...
    <p>No. Although, we highly recommend you be residing in the Bay Area, as this will make it much easier for you to commute to and from Team Meetings and Teaching Meetings.</p>

    <p class="section-title"><span class="glyphicon glyphicon-triangle-right"></span>Where are the meetings held?</p>
    <p>Team Meeting locations are to be decided by Team Leaders, whereas, Teaching Meetings will usually be held in a meeting room at a local library. There will usually be one Team Meeting and one Teaching Meeting every week.</p>

    <p class="section-title"><span class="glyphicon glyphicon-triangle-right"></span>What is the expected time commitment?</p>
    <p>You are expected to attend every Team Meeting and Teaching Meeting. You can expect to dedicate 10-15 hours a week. We will be taking surveys at the beginning of each season and try to schedule the meetings around the participant's summer schedule.</p>

</div>

<p class="center bold">Don't see your question here? Please email to: <a href="mailto:nuleaftechnologies@gmail.com">nuleaftechnologies@gmail.com</a> and we will try to get back to you as quickly as possible.</p>
