<?php
    ...
    // Insert page CSS
    echo '<link type="text/css" rel="stylesheet" href="css/teams.css?v=1.1">';
    echo '<script type="text/javascript" src="js/teams.js"></script>';
?>
...
<div>
    ...
    <div id="readware" class="tiptext">
        <p><span class="bold">Photobiology/Photochemistry Team</span> - ensure system does not interfere with plant's photosynthetic pathway</p>
        <p><span class="bold">Biomimicry and Bio-inspired Team</span> - continual research to adhere to bio-inspired principles<p>
        <p><span class="bold">Sustainability and Healthy Integration Team</span> - promote a healthy ecosystem and plant</p>
    </div>

    <div id="liveware-coating" class="tiptext">
        <p><span class="bold">Genetic Engineering Team</span> - mechanism to generate usable nanostructures biologically</p>
    </div>

    <div id="liveware-network" class="tiptext">
        <p><span class="bold">Structural Team</span> - ideal structure and back-up alternatives other than nanotechnology</p>
    </div>

    <div id="hardware" class="tiptext">
        <p><span class="bold">Root Wiring Mesh Team</span> - conductive material in soil linking plant to power harvester</p>
        <p><span class="bold">External Power Harvester Team</span> - stores and supplies energy to make it accessible to consumer</p>
    </div>

    <div id="software" class="tiptext">
        <p><span class="bold">Information Technologies Team</span> - public interface as well as central team communication hub</p>
        <p><span class="bold">Nano-Simulations Team</span> - creates an animation of protein-nanoscale interactions</p>
        <p><span class="bold">Patent Search Team</span> - gain inspiration from previous inventions and technology</p>
    </div>
    ...
    together to solve wide-ranging scientific problems. 
</div>
