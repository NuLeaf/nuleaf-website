  ...
  <div class="container-fluid">
    ...
    <ul class="list-group">
      @foreach ($events as $event)
        <li class="resource list-group-item peelable row">
          ...
          <div class="col-md-2 col-md-offset-1 col-md-push-9 text-right">
            <div aria-label="Actions" class="btn-group" role="group">
              ...
              <a class="btn btn-default" data-href="{{ action('EventsController@update', $event) }}" data-backdrop="static" data-close="dblclick" data-resource='{ "title":"{{ htmlspecialchars(htmlspecialchars($event->title)) }}", "location":"{{ $event->location }}", "date":"{{ $event->date->format('m/d/Y h:i a') }}" }' data-resource-title="Event" data-form="modal" data-method="patch" data-target="#form-modal" data-toggle="modal" role="button">
