...
@section('content')
<div class="container">
  <h1 class="page-title theme-text">Teams</h1>
  <hr />
  <div class="page-content">
    <h3 class="theme-text">ORIGINAL PROPOSAL</h3>
    <p>
    ...
    <hr />
    <h3 class="theme-text">MICROBIAL FUEL CELL (MFC)</h3>
    <p>
    ...
    <hr />
    <h3 class="theme-text">CUTICULAR SOLAR CELL (CSC)</h3>
    <p>
    ...
    <hr />
    <h3 class="theme-text">WEBSITE AND FORUM</h3>
    <p>
    ...
    <hr />
    <h3 class="theme-text">GRANT WRITING AND MANAGERIAL TEAMS</h3>
    <p>
    ...
    <hr />
    <h3 class="theme-text">UPCOMING PLANS</h3>
    <p>
