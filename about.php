...
<div>
    ...
    <p>
        ...
        materials and not requiring constant maintenance. 
    </p>
    <h4>ABSTRACT</h4>
    <p>
    ...
    <p>
        Our first research steps are an extensive literature search and generation of experimental design reports aimed to define proof of concept.  We plan to pursue sources of funding such as grants,  
        academic institutions such as Foothill College, and scientific organizations like AVS. We aim to continually recruit top student talent from Silicon Valley academic institutions to ensure the 
